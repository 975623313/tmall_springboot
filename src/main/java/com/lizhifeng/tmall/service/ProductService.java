...
import com.lizhifeng.tmall.dao.ProductDAO;
import com.lizhifeng.tmall.es.ProductESDAO;
...
//	@CacheEvict(allEntries=true)
//	public void updateNum(Product bean) {
//		System.out.println("updateNum"+bean);
//		productDAO.save(bean);
//		productESDAO.save(bean);
//	}
